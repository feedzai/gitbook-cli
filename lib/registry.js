...
function availableVersions() {
    return initNPM()
    .then(function() {
        return Q.nfcall(npm.commands.view, ['@feedzai/gitbook', 'versions', 'dist-tags'], true);
    })
...
function installVersion(version, forceInstall) {
    ...
    .then(function(tmpDir) {
        var gitbookRoot = path.resolve(tmpDir, 'node_modules/@feedzai/gitbook');
